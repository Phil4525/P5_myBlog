...
class Dot {
    ...
    checkEdges() {
        ...
        // if (this.x < canvas.width / 4 || this.x > canvas.width - canvas.width / 4) { this.velocity.x *= -1 }
        if (this.y < 0 || this.y > canvas.height) { this.velocity.y *= -1 }
        // if (this.y < canvas.height / 4 || this.y > canvas.height - canvas.height / 4) { this.velocity.y *= -1 }
    }
}
